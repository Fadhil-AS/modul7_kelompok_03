...
namespace modul7_kelompok_03
{
    ...
    internal class TeamMembers1302213012
    {
        public List<members> members { set; get; }

        public TeamMembers1302213012() { }
        public TeamMembers1302213012(List<members> members)
        {
        ...
        public void ReadJSON()
        {
            String json = File.ReadAllText(
                    "C:\\Users\\PRAKTIKAN\\Downloads\\modul7_kelompok_03\\modul7_kelompok_03\\jurnal7_2_1302213012.json"
            );
            TeamMembers1302213012 obj = JsonSerializer.Deserialize<TeamMembers1302213012>(json);
